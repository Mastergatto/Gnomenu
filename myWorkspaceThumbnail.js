...
class GnoMenu_MyPrimaryActorLayout extends Clutter.FixedLayout {
    _init(primaryActor) {
        super._init();
...
var MyThumbnailsBox = GObject.registerClass({
    ...
    addThumbnails(start, count) {
        ...
        for (let k = start; k < start + count; k++) {
            ...
            let thumbnail = new MyWorkspaceThumbnail(metaWorkspace, this._parentMenu);
    ...
    vfunc_get_preferred_height(forWidth) {
        ...
        let naturalHeight = totalSpacing + nWorkspaces * this._porthole.height * scale;
